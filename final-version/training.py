...
if __name__ == "__main__":
    ...
    parser.add_argument('--qnsf', type='int', required=False)
    parser.add_argument('--cod_type', type='int', required=False)
    parser.add_argument('--seq_len', type='int', required=False)
    parser.add_argument('--batch_size', type='int', required=False)
    parser.add_argument('--epochs', type='int', required=False)
    parser.add_argument('--data_len_train', type='int', required=False)
    parser.add_argument('--data_len_val', type='int', required=False)
    parser.add_argument('--data_len_test', type='int', required=False)
    parser.add_argument('--rnn_dim', type='int', required=False)
    parser.add_argument('--rnn_layers', type='int', required=False)
    parser.add_argument('--teacher_forcing', type='float', required=False)
